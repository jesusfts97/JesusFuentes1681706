USE [Proyecto]
GO
/****** Object:  Trigger [Trigger_Registro_INSERT]    Script Date: 06/12/2019 10:14:05 ******/
DROP TRIGGER [dbo].[Trigger_Registro_INSERT]
GO
/****** Object:  Trigger [trigger_2]    Script Date: 06/12/2019 10:14:05 ******/
DROP TRIGGER [dbo].[trigger_2]
GO
/****** Object:  StoredProcedure [dbo].[V_8]    Script Date: 06/12/2019 10:14:05 ******/
DROP PROCEDURE [dbo].[V_8]
GO
/****** Object:  StoredProcedure [dbo].[V_7]    Script Date: 06/12/2019 10:14:05 ******/
DROP PROCEDURE [dbo].[V_7]
GO
/****** Object:  StoredProcedure [dbo].[V_6]    Script Date: 06/12/2019 10:14:05 ******/
DROP PROCEDURE [dbo].[V_6]
GO
/****** Object:  StoredProcedure [dbo].[V_5]    Script Date: 06/12/2019 10:14:05 ******/
DROP PROCEDURE [dbo].[V_5]
GO
/****** Object:  StoredProcedure [dbo].[V_4]    Script Date: 06/12/2019 10:14:05 ******/
DROP PROCEDURE [dbo].[V_4]
GO
/****** Object:  StoredProcedure [dbo].[V_3]    Script Date: 06/12/2019 10:14:05 ******/
DROP PROCEDURE [dbo].[V_3]
GO
/****** Object:  StoredProcedure [dbo].[V_2]    Script Date: 06/12/2019 10:14:05 ******/
DROP PROCEDURE [dbo].[V_2]
GO
/****** Object:  StoredProcedure [dbo].[V_1]    Script Date: 06/12/2019 10:14:05 ******/
DROP PROCEDURE [dbo].[V_1]
GO
/****** Object:  View [dbo].[Tutor]    Script Date: 06/12/2019 10:14:05 ******/
DROP VIEW [dbo].[Tutor]
GO
/****** Object:  View [dbo].[Resultados]    Script Date: 06/12/2019 10:14:05 ******/
DROP VIEW [dbo].[Resultados]
GO
/****** Object:  View [dbo].[horario]    Script Date: 06/12/2019 10:14:05 ******/
DROP VIEW [dbo].[horario]
GO
/****** Object:  View [dbo].[Empleados_con_Bono]    Script Date: 06/12/2019 10:14:05 ******/
DROP VIEW [dbo].[Empleados_con_Bono]
GO
/****** Object:  View [dbo].[ClaseAsignada]    Script Date: 06/12/2019 10:14:05 ******/
DROP VIEW [dbo].[ClaseAsignada]
GO
/****** Object:  View [dbo].[AsignacionBecarios]    Script Date: 06/12/2019 10:14:05 ******/
DROP VIEW [dbo].[AsignacionBecarios]
GO
/****** Object:  View [dbo].[Alumnos_Reprobados]    Script Date: 06/12/2019 10:14:05 ******/
DROP VIEW [dbo].[Alumnos_Reprobados]
GO
/****** Object:  View [dbo].[Alumnos_Aprobados]    Script Date: 06/12/2019 10:14:05 ******/
DROP VIEW [dbo].[Alumnos_Aprobados]
GO
/****** Object:  Table [dbo].[Registro]    Script Date: 06/12/2019 10:14:05 ******/
DROP TABLE [dbo].[Registro]
GO
/****** Object:  Table [dbo].[Materia]    Script Date: 06/12/2019 10:14:05 ******/
DROP TABLE [dbo].[Materia]
GO
/****** Object:  Table [dbo].[Maestro]    Script Date: 06/12/2019 10:14:05 ******/
DROP TABLE [dbo].[Maestro]
GO
/****** Object:  Table [dbo].[Grupo]    Script Date: 06/12/2019 10:14:05 ******/
DROP TABLE [dbo].[Grupo]
GO
/****** Object:  Table [dbo].[Facultad]    Script Date: 06/12/2019 10:14:05 ******/
DROP TABLE [dbo].[Facultad]
GO
/****** Object:  Table [dbo].[Empleado]    Script Date: 06/12/2019 10:14:05 ******/
DROP TABLE [dbo].[Empleado]
GO
/****** Object:  Table [dbo].[Departamento]    Script Date: 06/12/2019 10:14:05 ******/
DROP TABLE [dbo].[Departamento]
GO
/****** Object:  Table [dbo].[Carrera]    Script Date: 06/12/2019 10:14:05 ******/
DROP TABLE [dbo].[Carrera]
GO
/****** Object:  Table [dbo].[Calificacion]    Script Date: 06/12/2019 10:14:05 ******/
DROP TABLE [dbo].[Calificacion]
GO
/****** Object:  Table [dbo].[Becarios]    Script Date: 06/12/2019 10:14:05 ******/
DROP TABLE [dbo].[Becarios]
GO
/****** Object:  Table [dbo].[Alumnos]    Script Date: 06/12/2019 10:14:05 ******/
DROP TABLE [dbo].[Alumnos]
GO
USE [master]
GO
/****** Object:  Database [Proyecto]    Script Date: 06/12/2019 10:14:05 ******/
...
CREATE DATABASE [Proyecto]
 CONTAINMENT = NONE
 ON  PRIMARY 
( NAME = N'Proyecto', FILENAME = N'C:\Program Files\Microsoft SQL Server\MSSQL12.SERVIDOR\MSSQL\DATA\Proyecto.mdf' , SIZE = 4288KB , MAXSIZE = UNLIMITED, FILEGROWTH = 1024KB )
 LOG ON 
( NAME = N'Proyecto_log', FILENAME = N'C:\Program Files\Microsoft SQL Server\MSSQL12.SERVIDOR\MSSQL\DATA\Proyecto_log.ldf' , SIZE = 1072KB , MAXSIZE = 2048GB , FILEGROWTH = 10%)
GO
...
INSERT [dbo].[Registro] ([id], [Registro], [fecha]) VALUES (1, N'Se agregó el ID        13', N'Dec  6 2019 10:07AM')
INSERT [dbo].[Registro] ([id], [Registro], [fecha]) VALUES (2, N'Se elimino el ID        13', N'Dec  6 2019 10:08AM')
/****** Object:  StoredProcedure [dbo].[V_1]    Script Date: 06/12/2019 10:14:05 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
...
GO
/****** Object:  Trigger [dbo].[trigger_2]    Script Date: 06/12/2019 10:14:05 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
    ...
    END
GO
/****** Object:  Trigger [dbo].[Trigger_Registro_INSERT]    Script Date: 06/12/2019 10:14:05 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
