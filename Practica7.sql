USE [practica_7]
GO
/****** Object:  View [dbo].[Tutor]    Script Date: 04/12/2019 1:22:38 ******/
DROP VIEW [dbo].[Tutor]
GO
/****** Object:  View [dbo].[Resultados]    Script Date: 04/12/2019 1:22:38 ******/
DROP VIEW [dbo].[Resultados]
GO
/****** Object:  View [dbo].[horario]    Script Date: 04/12/2019 1:22:38 ******/
DROP VIEW [dbo].[horario]
GO
/****** Object:  View [dbo].[Empleados_con_Bono]    Script Date: 04/12/2019 1:22:38 ******/
DROP VIEW [dbo].[Empleados_con_Bono]
GO
/****** Object:  View [dbo].[ClaseAsignada]    Script Date: 04/12/2019 1:22:38 ******/
DROP VIEW [dbo].[ClaseAsignada]
GO
/****** Object:  View [dbo].[AsignacionBecarios]    Script Date: 04/12/2019 1:22:38 ******/
DROP VIEW [dbo].[AsignacionBecarios]
GO
/****** Object:  View [dbo].[Alumnos_Reprobados]    Script Date: 04/12/2019 1:22:38 ******/
DROP VIEW [dbo].[Alumnos_Reprobados]
GO
/****** Object:  View [dbo].[Alumnos_Aprobados]    Script Date: 04/12/2019 1:22:38 ******/
DROP VIEW [dbo].[Alumnos_Aprobados]
GO
/****** Object:  Table [dbo].[Materia]    Script Date: 04/12/2019 1:22:38 ******/
DROP TABLE [dbo].[Materia]
GO
/****** Object:  Table [dbo].[Maestro]    Script Date: 04/12/2019 1:22:38 ******/
DROP TABLE [dbo].[Maestro]
GO
/****** Object:  Table [dbo].[Grupo]    Script Date: 04/12/2019 1:22:38 ******/
DROP TABLE [dbo].[Grupo]
GO
/****** Object:  Table [dbo].[Facultad]    Script Date: 04/12/2019 1:22:38 ******/
DROP TABLE [dbo].[Facultad]
GO
/****** Object:  Table [dbo].[Empleado]    Script Date: 04/12/2019 1:22:38 ******/
DROP TABLE [dbo].[Empleado]
GO
/****** Object:  Table [dbo].[Departamento]    Script Date: 04/12/2019 1:22:38 ******/
DROP TABLE [dbo].[Departamento]
GO
/****** Object:  Table [dbo].[Carrera]    Script Date: 04/12/2019 1:22:38 ******/
DROP TABLE [dbo].[Carrera]
GO
/****** Object:  Table [dbo].[Calificacion]    Script Date: 04/12/2019 1:22:38 ******/
DROP TABLE [dbo].[Calificacion]
GO
/****** Object:  Table [dbo].[Becarios]    Script Date: 04/12/2019 1:22:38 ******/
DROP TABLE [dbo].[Becarios]
GO
/****** Object:  Table [dbo].[Alumnos]    Script Date: 04/12/2019 1:22:38 ******/
DROP TABLE [dbo].[Alumnos]
GO
USE [master]
GO
/****** Object:  Database [practica_7]    Script Date: 04/12/2019 1:22:38 ******/
DROP DATABASE [practica_7]
GO
/****** Object:  Database [practica_7]    Script Date: 04/12/2019 1:22:38 ******/
CREATE DATABASE [practica_7]
 CONTAINMENT = NONE
 ON  PRIMARY 
( NAME = N'practica_7', FILENAME = N'C:\Program Files\Microsoft SQL Server\MSSQL12.SERVIDOR\MSSQL\DATA\practica_7.mdf' , SIZE = 4288KB , MAXSIZE = UNLIMITED, FILEGROWTH = 1024KB )
 LOG ON 
( NAME = N'practica_7_log', FILENAME = N'C:\Program Files\Microsoft SQL Server\MSSQL12.SERVIDOR\MSSQL\DATA\practica_7_log.ldf' , SIZE = 1072KB , MAXSIZE = 2048GB , FILEGROWTH = 10%)
GO
ALTER DATABASE [practica_7] SET COMPATIBILITY_LEVEL = 120
GO
IF (1 = FULLTEXTSERVICEPROPERTY('IsFullTextInstalled'))
begin
EXEC [practica_7].[dbo].[sp_fulltext_database] @action = 'enable'
end
GO
ALTER DATABASE [practica_7] SET ANSI_NULL_DEFAULT OFF 
GO
ALTER DATABASE [practica_7] SET ANSI_NULLS OFF 
GO
ALTER DATABASE [practica_7] SET ANSI_PADDING OFF 
GO
ALTER DATABASE [practica_7] SET ANSI_WARNINGS OFF 
GO
ALTER DATABASE [practica_7] SET ARITHABORT OFF 
GO
ALTER DATABASE [practica_7] SET AUTO_CLOSE ON 
GO
ALTER DATABASE [practica_7] SET AUTO_SHRINK OFF 
GO
ALTER DATABASE [practica_7] SET AUTO_UPDATE_STATISTICS ON 
GO
ALTER DATABASE [practica_7] SET CURSOR_CLOSE_ON_COMMIT OFF 
GO
ALTER DATABASE [practica_7] SET CURSOR_DEFAULT  GLOBAL 
GO
ALTER DATABASE [practica_7] SET CONCAT_NULL_YIELDS_NULL OFF 
GO
ALTER DATABASE [practica_7] SET NUMERIC_ROUNDABORT OFF 
GO
ALTER DATABASE [practica_7] SET QUOTED_IDENTIFIER OFF 
GO
ALTER DATABASE [practica_7] SET RECURSIVE_TRIGGERS OFF 
GO
ALTER DATABASE [practica_7] SET  ENABLE_BROKER 
GO
ALTER DATABASE [practica_7] SET AUTO_UPDATE_STATISTICS_ASYNC OFF 
GO
ALTER DATABASE [practica_7] SET DATE_CORRELATION_OPTIMIZATION OFF 
GO
ALTER DATABASE [practica_7] SET TRUSTWORTHY OFF 
GO
ALTER DATABASE [practica_7] SET ALLOW_SNAPSHOT_ISOLATION OFF 
GO
ALTER DATABASE [practica_7] SET PARAMETERIZATION SIMPLE 
GO
ALTER DATABASE [practica_7] SET READ_COMMITTED_SNAPSHOT OFF 
GO
ALTER DATABASE [practica_7] SET HONOR_BROKER_PRIORITY OFF 
GO
ALTER DATABASE [practica_7] SET RECOVERY SIMPLE 
GO
ALTER DATABASE [practica_7] SET  MULTI_USER 
GO
ALTER DATABASE [practica_7] SET PAGE_VERIFY CHECKSUM  
GO
ALTER DATABASE [practica_7] SET DB_CHAINING OFF 
GO
ALTER DATABASE [practica_7] SET FILESTREAM( NON_TRANSACTED_ACCESS = OFF ) 
GO
ALTER DATABASE [practica_7] SET TARGET_RECOVERY_TIME = 0 SECONDS 
GO
ALTER DATABASE [practica_7] SET DELAYED_DURABILITY = DISABLED 
GO
USE [practica_7]
GO
/****** Object:  Table [dbo].[Alumnos]    Script Date: 04/12/2019 1:22:38 ******/
...
GO
INSERT [dbo].[Alumnos] ([id_alumnos], [nombre], [apellido_paterno], [apellido_materno]) VALUES (1681706, N'Jesus', N'Antonio', N'Fuentes')
...
USE [master]
GO
ALTER DATABASE [practica_7] SET  READ_WRITE 
GO